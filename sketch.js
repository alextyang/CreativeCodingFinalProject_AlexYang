...
function newRounds() { // Creates a new set of goals
	
	roundVectors = [[createVector(0, 0), createVector(0, 0), createVector(0, height)],
									[createVector(0, 0), createVector(0, 0), createVector(0, 0)],
									[createVector(0, 0), createVector(0, 0), createVector(width, 0)],
									[createVector(0, 0), createVector(0, 0), createVector(width, height)]];
	
	let pos = int(random(50, 600));
	let side = (random(0,1) < .5);
	roundVectors[0][0] = createVector(pos, side ? height : 0);
	roundVectors[1][1] = createVector(pos, side ? 0 : height);
	
	pos = int(random(50, 440));
	side = (random(0,1) < .5);
	roundVectors[0][1] = createVector(side ? 0 : width, pos);
	roundVectors[3][0] = createVector(side ? width : 0, pos);
	
	pos = int(random(50, 440));
	side = (random(0,1) < .5);
	roundVectors[1][0] = createVector(side ? 0 : width, pos);
	roundVectors[2][1] = createVector(side ? width : 0, pos);
	
	pos = int(random(50, 600));
	side = (random(0,1) < .5);
	roundVectors[2][0] = createVector(pos, side ? height : 0);
	roundVectors[3][1] = createVector(pos, side ? 0 : height);
...
function mouseDragged() { // Cheat function for demo
...
function nextLevel() { // Starts the game over
	newRounds();
	currentRound = new Round(roundVectors[pastRounds.length][0], roundVectors[pastRounds.length][1]);
}
